        ...
        <div class="container" id="cruise-info">
            <div class="row">
                <div class="col-xl-12" align="center" style="border:1px solid #333; font-weight: bold; font-size: larger; padding: 5px">
                        ${cruise.name} (<fmt:message key="${cruise.shipClass.key}"/>) - ${cruise.cruiseDuration} <fmt:message key="ship_days"/>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-9" style="border:1px solid #333; font-size: medium">
                    <div style="padding: 5px">
                        ...
                        <span style="font-weight: bold"><fmt:message key="ship_staff"/>: </span>${cruise.staff}<br>
