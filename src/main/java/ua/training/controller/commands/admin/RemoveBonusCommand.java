...
public class RemoveBonusCommand implements Command {
    private final static Logger logger = LogManager.getLogger(RemoveBonusCommand.class);
    ...
    public ServletAction execute(HttpServletRequest request) {
        ...
        shipService.removeBonusFromShip(ship.getId(), bonus);
        logger.info(String.format(Messages.LOG_REMOVE_BONUS,
