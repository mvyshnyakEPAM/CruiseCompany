        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="bonus" items="${requestScope.shipBonuses}">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/company/remove-bonus?ship=${sessionScope.ship.id}&&bonus=${bonus}" class="btn btn-warning font-weight-bold">Remove</a> </td>
                </tr>
            </c:forEach>
            <tr>
                <td></td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="bonus" items="${requestScope.bonuses}">
                                            <tr>
                                                <td><fmt:message key="${bonus.key}"/></td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/company/add-bonus?bonus=${bonus}" class="btn btn-warning font-weight-bold">Add</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
